...
call :ExecuteCmd "%DEPLOYMENT_TARGET%\env\Scripts\activate.bat" 2>nul
IF !ERRORLEVEL! NEQ 0 (
  call :ExecuteCmd "%DEPLOYMENT_TARGET%\env\Scripts\activate" 2>nul
  IF !ERRORLEVEL! NEQ 0 (
...
call :ExecuteCmd echo gunicorn --bind=0.0.0.0 --timeout 600 run:app > "%DEPLOYMENT_TARGET%\startup.txt"
